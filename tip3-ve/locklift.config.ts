...
const MAIN_NET_NETWORK_ENDPOINT = process.env.MAIN_NET_NETWORK_ENDPOINT || "https://mainnet.evercloud.dev/30d28cb6bdb049d194aa052e71ddd854/graphql";
...
const config: LockliftConfig = {
  compiler: {
    ...
    // Specify config for extarnal contract
    externalContracts: {
